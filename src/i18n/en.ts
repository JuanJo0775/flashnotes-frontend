...
export const en: Dictionary = {
    ...
    'pong.hintVersus': '[2] TWO PLAYERS  ·  [ESC] PAUSE',
    'pong.hintWall': '[1] AGAINST THE WALL  ·  TO {score}  ·  [ESC] PAUSE',
    'pong.lost': 'IT GOT AWAY. RALLY {rally}.',
    'pong.won': '{side} WINS.',
    'pong.paused': '■ ■  P A U S E D  ■ ■',
    'pong.resume': '[ENTER] RESUME  ·  [ESC] EXIT',
    'pong.again': '[ENTER] AGAIN  ·  [ESC] EXIT',
