...
export const es = {
    ...
    'pong.hintVersus': '[2] DOS JUGADORES  ·  [ESC] PAUSA',
    'pong.hintWall': '[1] CONTRA LA PARED  ·  A {score}  ·  [ESC] PAUSA',
    'pong.lost': 'SE ESCAPÓ. PELOTEO {rally}.',
    'pong.won': 'GANA {side}.',
    'pong.paused': '■ ■  P A U S A  ■ ■',
    'pong.resume': '[ENTER] CONTINUAR  ·  [ESC] SALIR',
    'pong.again': '[ENTER] OTRA  ·  [ESC] SALIR',
