...
/*
 * ⚠ AQUÍ HABÍA DOS TESTS DEL LATIDO DEL BARRIDO Y SE FUERON CON ÉL.
 *
 * Ataban un oscilador a 1/9 Hz contra la animación del CSS, y estaban bien
 * hechos. El sonido, no: escuchándolo molestaba. Un fondo que PULSA reclama
 * atención, y un fondo que reclama atención deja de ser un fondo.
 */
